...
public class TimerProtocol implements BlueToothDataListener, BlueToothStatusListener {
    ...
    private static final int WRITE_RESULT_OK = 0x00;
    private static final int WRITE_RESULT_FAIL = 0x01;
    ...
    public void writeSettingsIntoTimer(byte[] xmlPart, byte[] dataPart) {
    ...
    private void sendWriteResult(int status) {
